      ...
      <React.Fragment>
        <form className="modal-content" id='form'>
          <div className="container">
            ...
            <br/>
            <br/>
            <label htmlFor="jumprange"><b className="tooltip" style={{ color: "white" }}>The jumprange of your ratship in lightyears (ly) *<span class="tooltiptext">Should be at least 25ly</span></b></label>
            <br/>
